    ...
    "paths": {
        ...
        "/content-creators": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "creator inscription or null",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/content-creators/stats-advenced/creator": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/likes/statistics": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "total: total number of likes, daily_data: array of daily like creation data",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
